...
function FeatureCard(props: FeatureCardProps) {
  return (
    <div className="h-[23.5rem] w-[21rem] rounded-3xl border-black border-solid border-[1px] overflow-hidden items-stretch">
      <div className="flex h-max items-center justify-around p-4 text-lg bg-white">
        ...
        <div className="text-center font-medium bg-white">{props.title}</div>
      </div>
