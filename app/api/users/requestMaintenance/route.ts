...
export async function POST(request: NextRequest) {
  try {
    ...
    const userValidation = await validateUserOwnership(parseInt(id), parseInt(property_id));
    ...
    const databaseResponse = await insertMaintenanceRequest(requestInfo, parseInt(property_id), parseInt(id))
