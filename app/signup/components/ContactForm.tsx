    ...
    <div className="flex min-h-screen">
      <div className="w-2/3 px-20 min-h-full flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col justify-bewteen">
          <div className="w-full grid grid-cols-2 gap-x-16 gap-y-4">
            <div>
          ...
          <div className="col-span-2 flex gap-8 justify-center my-9">
            <Button
              type="button"
              classes={`${hasPrevResidence ? "bg-customRed-80" : "bg-gray-200"} text-md`}
          ...
          {!hasPrevResidence && (
            <div className="col-span-2">
              <textarea
                ...
                rows={4}
                className="resize-none p-2 w-full rounded-xl border border-gray-300"
              />
            </div>
          )}
          {hasPrevResidence && (
            <div className="w-full grid grid-cols-2 gap-x-16 gap-y-4">
              <div>
                ...
                <input
                  ...
                  {...props.register("prev_landlord.name")}
                />
                {props.errors.prev_landlord?.name && (
                  <p className="text-red-500 ml-2">
                    {props.errors.prev_landlord.name.message}
                  </p>
                )}
              </div>
              <div>
                ...
                <input
                  ...
                  {...props.register("prev_landlord.email")}
                />
                {props.errors.prev_landlord?.email && (
                  <p className="text-red-500 ml-2">
                    {props.errors.prev_landlord.email.message}
                  </p>
                )}
              </div>
              <div>
                <label
                  htmlFor="landlord_contact"
                  className="mb-1 ml-2 font-medium"
                >
                  Phone&nbsp;
                  <span className="text-red-500 font-extrabold">*</span>
                ...
                <input
                  ...
                  id="landlord_contact"
                  className="w-full px-4 py-2 border border-gray-300 rounded-full"
                  placeholder="Landlord's Phone No."
                  {...props.register("prev_landlord.contact")}
                />
                {props.errors.prev_landlord?.contact && (
                  <p className="text-red-500 ml-2">
                    {props.errors.prev_landlord.contact.message}
                  </p>
                )}
              </div>
              <div>
                ...
                <select
                  id="landlord_state"
                  className="w-full px-4 py-2 border border-gray-300 rounded-full bg-white"
                  {...props.register("prev_landlord.state")}
                >
                  <option value="">Select your option</option>
                  <option value="state1">State 1</option>
                  <option value="state2">State 2</option>
                </select>
                {props.errors.prev_landlord?.state && (
                  <p className="text-red-500 ml-2">
                    {props.errors.prev_landlord.state.message}
                  </p>
                )}
              </div>
              <div>
                <label
                  htmlFor="landlord_region"
                  className="mb-1 ml-2 font-medium"
                >
                  Region&nbsp;
                  <span className="text-red-500 font-extrabold">*</span>
                ...
                <select
                  id="landlord_region"
                  className="w-full px-4 py-2 border border-gray-300 rounded-full bg-white"
                  {...props.register("prev_landlord.region")}
                >
                  <option value="">Select your option</option>
                  <option value="region1">Region 1</option>
                  <option value="region2">Region 2</option>
                </select>
                {props.errors.prev_landlord?.region && (
                  <p className="text-red-500 ml-2">
                    {props.errors.prev_landlord.region.message}
                  </p>
                )}
              </div>
              <div>
                <label
                  htmlFor="landlord_subdivision"
                  className="mb-1 ml-2 font-medium"
                >
                  Subdivision
                </label>
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-full"
                  placeholder="Sub-division name"
                  {...props.register("prev_landlord.sub_division")}
                />
                {props.errors.prev_landlord?.sub_division && (
                  <p className="text-red-500 ml-2">
                    {props.errors.prev_landlord.sub_division.message}
                  </p>
                )}
              </div>
              <div className="col-span-2">
                <label
                  htmlFor="landlord_street"
                  className="mb-1 ml-2 font-medium"
                >
                  Street
                </label>
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-full"
                  placeholder="Address Street"
                  {...props.register("prev_landlord.street")}
                />
                {props.errors.prev_landlord?.street && (
                  <p className="text-red-500 ml-2">
                    {props.errors.prev_landlord.street.message}
                  </p>
                )}
              </div>
            </div>
          )}
          <div className="col-span-2 flex items-center justify-center space-x-2 mt-4 text-md">
            <input
              ref={t_and_c}
          ...
          <div className="col-span-2 w-full flex justify-between mt-6 mb-10">
            <Button
              label="Back"
